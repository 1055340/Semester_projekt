...
$('.categories').on('click', function () {
    ...
    var strengthContent = "<form action= '/Manage/CreateChallenge' method= 'post' class='form-horizontal' > <input name='ExerciseId' type='hidden' value=" + id + " ><input class='Challenged' name='ChallengedId' type='hidden' value=" + challengedId + "><div class='row modal-append'><div class='challenge-img col-xs-12'><h2>" + thiscategory + "</h2></div><div class='col-xs-12'><div class='col-xs-8 col-xs-offset-2'><input name='ChallengeTitle' required placeholder='Title' type='text' class='exercise-input'><input name='ChallengeGoal' required placeholder='Goal in total KG' type='number' class='exercise-input'></div></div><div class='col-xs-12'><div class='col-xs-8 col-xs-offset-2'></div><div class='col-xs-8 col-xs-offset-2'><h4>End date</h4><input name='ChallengeEnd' required placeholder='End Date' type='date' class='exercise-input'></div></div><div class='col-xs-12'><div class='col-xs-8 col-xs-offset-2'><button type='submit' class='create-challenge-btn'>Challenge " + challengedName + " </button><button type='cancel' class='cancel-exercise' data-dismiss='modal'>Cancel</button></div></div></div></form>";

    //var cardioContent = "<form action= '/Manage/CreateChallenge' method= 'post' class='form-horizontal' > <input name='ExerciseId' type='hidden' value=" + id + " ><input class='Challenged' name='ChallengedId' type='hidden' value=" + challengedId + "><div class='row modal-append'><div class='challenge-img col-xs-12'><h2>" + thiscategory + "</h2></div><div class='col-xs-12'><div class='col-xs-8 col-xs-offset-2'><input name='ChallengeTitle' required placeholder='Title' type='text' class='form-control'><input name='ChallengeGoal' required placeholder='Goal in total KM' type='text' class='form-control'></div></div><div class='col-xs-12'><div class='col-xs-6 col-xs-offset-3'></div><div class='col-xs-6 col-xs-offset-3'><h3>End date</h3><input name='ChallengeEnd' required placeholder='End Date' type='date' class='form-control'></div></div><div class='col-xs-12'><div class='col-xs-8 col-xs-offset-2'><button type='submit' class='btn btn-success btn-md'>Challenge " + challengedName + "!</button><button type='cancel' class='btn btn-danger btn-md' data-dismiss='modal'>Cancel</button></div></div></div></form>";
    var cardioContent = "<form action= '/Manage/CreateChallenge' method= 'post' class='form-horizontal' > <input name='ExerciseId' type='hidden' value=" + id + " ><input class='Challenged' name='ChallengedId' type='hidden' value=" + challengedId + "><div class='row modal-append'><div class='challenge-img col-xs-12'><h2>" + thiscategory + "</h2></div><div class='col-xs-12'><div class='col-xs-8 col-xs-offset-2'><input name='ChallengeTitle' required placeholder='Title' type='text' class='exercise-input'><input name='ChallengeGoal' required placeholder='Goal in total KM' type='number' class='exercise-input'></div></div><div class='col-xs-12'><div class='col-xs-8 col-xs-offset-2'></div><div class='col-xs-8 col-xs-offset-2'><h4>End date</h4><input name='ChallengeEnd' required placeholder='End Date' type='date' class='exercise-input'></div></div><div class='col-xs-12'><div class='col-xs-8 col-xs-offset-2'><button type='submit' class='create-challenge-btn'>Challenge " + challengedName + " </button><button type='cancel' class='cancel-exercise' data-dismiss='modal'>Cancel</button></div></div></div></form>";
